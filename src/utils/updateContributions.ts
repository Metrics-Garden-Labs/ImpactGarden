...
//     // Update the userFid for existing contributions that match by project name
//     for (const existingContribution of existingContributions) {
//       const newUserFid = projectNameToUserFid.get(
//         existingContribution.projectName
//       );
//       if (newUserFid) {
//         console.log(
//           `Updating contribution: ${existingContribution.projectName} with userFid: ${newUserFid}`
//         );
//         await db
