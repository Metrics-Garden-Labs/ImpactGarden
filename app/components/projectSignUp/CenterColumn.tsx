  ...
  if (isPreview) {
    return (
      <div className="w-full md:w-1/2 lg:w-1/3 bg-white p-8 shadow-lg rounded mx-auto">
        ...
        <p className='text-center text-sm text-gray-500 mb-2'> Clicking ’Confirm & Attest’ will create 2 attestations. Please wait for them to complete.</p>
        ...
        <div className="flex justify-center space-x-4 mt-20 mb-20">
          ...
          <button
            className="px-4 py-2 w-full sm:w-1/3 md:w-1/4 lg:w-1/5 text-xs sm:text-sm font-medium text-gray-700 bg-white border border-lime-900/30 rounded-md shadow-sm hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
            type="button"
